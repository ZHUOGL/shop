...
<TR>
<TD>
<IMG src="images/Snap1.jpg"><DIV style="position:absolute; left: 900px; top: 216px; width: 356px;">
...
//    if("admin".equals(userId)&&"123456".equals(passwd))
//    {
//        request.getRequestDispatcher(basePath+"success.jsp");
//    }
//    else {
//        response.sendRedirect( basePath+"mailLogin.jsp");
//    }
